        ...
        @csrf
            ...
            <option value="servicios_especiales">Servicios Especiales</option>
				...
				<div class="flex justify-center">
					<button type="submit" class="w-1/2 py-2 px-4 bg-purple-600 text-white font-bold rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50">Guardar Servicio <i class="ml-3 fa-solid fa-download"></i></button>
				</div>
			</form>
	</div>
</div>
