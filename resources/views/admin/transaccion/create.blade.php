...
<div class="container">
    ...
    <form action="{{ route('transaccion.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" name="precio_servicio" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="idTipoTX">Método de Pago</label>
            <select name="idTipoTX" class="form-control" required>
        ...
        <div class="form-group">
            ...
            <input type="number" step="0.01" name="itbms" class="form-control">
        </div>
        <div class="form-group">
            <label for="descuento_producto">Descuento Producto</label>
            <input type="number" step="0.01" name="descuento_producto" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="total_transaccion">Total Transacción</label>
            <input type="number" step="0.01" name="total_transaccion" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="monto_salon">Monto Salón</label>
            <input type="number" step="0.01" name="monto_salon" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="monto_empleado">Monto Empleado</label>
            <input type="number" step="0.01" name="monto_empleado" class="form-control" required>
        </div>
